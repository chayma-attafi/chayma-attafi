...
* 💡 &nbsp; Worked on personal projects:AI Agent, mobile apps, web apps, and more.
...
Mirror is a revolutionary solution designed to enhance CRISPR-Cas9-based treatments, empowering biologists with advanced tools for precise genetic interventions. Powered by machine learning and digital twin technology, Mirror provides an intelligent, data-driven platform featuring an interactive dashboard, guide RNA efficiency tool, 3D CRISPR-Cas9 simulation, sequence analysis, PDF report generation, and digital twin monitoring. See Mirror in action with our demo! [Watch the demo video](https://www.linkedin.com/feed/update/urn:li:activity:7232038482397863937/)
